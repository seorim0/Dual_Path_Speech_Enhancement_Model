...
class Options:
    ...
    def init(self, parser):
        ...
        parser.add_argument('--lr_initial', type=float, default=0.00075, help='initial learning rate (default : 5e-4')
        parser.add_argument("--decay_epoch", type=int, default=30, help="epoch from which to start lr decay")
        parser.add_argument('--weight_decay', type=float, default=0.02, help='weight decay')

        # train settings
        parser.add_argument('--arch', type=str, default='MC', help='archtechture')
        ...
        parser.add_argument('--mid_ch', type=int, default=64, help='channel size for middle dim')
        parser.add_argument('--out_ch', type=int, default=128, help='channel size for output dim')
        ...
        parser.add_argument('--pretrain_model_path', type=str, default='./log/M.pt',
                            help='path of pretrained_weights')

        parser.add_argument('--test_name', type=str, default='base', help='wave write')
        parser.add_argument('--wav_write_flag', type=bool, default=False, help='wave write')
        parser.add_argument('--weight_load_type', type=str, default='SML', help='')
        parser.add_argument('--sc_update', type=bool, default=True, help='')
        parser.add_argument('--mc_update', type=bool, default=True, help='')
