...
class Writer(SummaryWriter):
    ...
    def log_weight_histogram(self, model, step):
        self.add_histogram('weights (real)', model.w1.data.cpu().numpy(), step)
        self.add_histogram('weights (imag)', model.w2.data.cpu().numpy(), step)
